...
contract PfProjectOne21 {
address owner;

 string public constant name = "Bugs Bunny Token"; //Tokens Name
 string public constant symbol = "BBT"; //Tokens Symbol
 uint public totalSupply = 10**18; //Tokens Total Supply
